...
- низкая скорость разработки новых блоков и поддержки имеющихся (как следствие вышеперечисленного)
...
<img src="https://i.imgur.com/1CdhwUH.png">
...
- упрощает создание плейграунда (компонентов для удобной разработки блоков в сторибуке)
...
- допиливание/переработка модели/скор-синк стратегий
- isCorrect в истории ответов (синке)
...
- и ещё кучка багов с `@angular/elements` (часть из которых как обычно не баги а by design и местами даже не ангуляра)
